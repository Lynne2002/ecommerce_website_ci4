      ...
      <br> <br>
               ...
               ?>
                   <div class="card">
                      <div class="card-header">
                           <h5>Product Data</h5>
                                <a href="<?= base_url('subcategories')?>" class="btn btn-primary btn-sm float-end">BACK</a>
                              </h5>
                       </div>
                       <div class="card-body">
            ...
            <tr>
               ...
               <td>
                ...
                <td>
                    <a href="<?= base_url('product/edit/'.$item['product_id'])?>"class="btn btn-success btn-sm">Edit</a></br>
                    <a href="<?= base_url('product/delete/'.$item['product_id'])?>"class="btn btn-danger btn-sm">Delete</a>
