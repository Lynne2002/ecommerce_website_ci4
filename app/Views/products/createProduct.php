           ...
           <div class="col-md-7">
                   <div class="card">
                      <div class="card-header">
                       ...
                       <div class="card-body">
                       <form action="<?=base_url('product-store')?>" name="ajax_form" id="ajax_form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                 <div class="form-group">
                                       <label for="usr">Product Name:</label>
                                            <input type="text" name="product_name" class="form-control" id="usr">
                               </div>
                            
                                <div class="form-group">
                                           <label for="comment">Product Description:</label>
                                          <textarea class="form-control" name="product_description" rows="5" id="description"></textarea>
                                </div>
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                     ...
                                     <input type="text" name="available_quantity" class="form-control" id="available_quantity:">
                                   </div>
