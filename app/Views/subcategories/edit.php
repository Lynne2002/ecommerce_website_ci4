           ...
           <div class="col-md-7">
                   <div class="card">
                      <div class="card-header">
                           <h5>Edit and Update Sub-Categories</h5>
                                <a href="<?= base_url('categories')?>" class="btn btn-danger btn-sm float-end">BACK</a>
                              </h5>
                       </div>
                       <div class="card-body">
                       <form action="<?=base_url('subcategory/update/'.$subcategory['subcategory_id'])?>" name="ajax_form" id="ajax_form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                       
                       <div class="form-group">
                                       <label for="usr">Sub Category Name:</label>
                                            <input type="text" value="<?=$subcategory['subcategory_name']?>" name="subcategory_name" class="form-control" id="usr">
                               </div>
