    ...
    <div class="container mt-4">
      ...
      <br> <br>
            ...
            <tr>
                ...
                <td>
                    <a href="<?= base_url('subcategory/edit/'.$item['subcategory_id'])?>"class="btn btn-success btn-sm">Edit</a></br>
                    <a href="<?= base_url('product/add/'.$item['subcategory_id'])?>"class="btn btn-danger btn-sm">Add product</a>
