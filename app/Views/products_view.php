...
<div class="profile-details">
    ...
    <div class="container mt-4">
        <div class="row">
           ...
           <div class="col-md-12">
                <h1>PRODUCTS </h1>
               <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for category  by name..">&nbsp; <i class="fas fa-search"></i>
...
<?php
    ...
    {?>
      ...
      <a href="<?= site_url('cart/buy/'.$value)?>"> <i class="fas fa-shopping-cart"></i>
