           ...
           <div class="col-md-7">
                   <div class="card">
                      <div class="card-header">
                       ...
                       <div class="card-body">
                       <form action="<?=base_url('category-store')?>" name="ajax_form" id="ajax_form" method="post" accept-charset="utf-8" >
                                 
                                            <input type="hidden" name="category" class="form-control" id="usr" value="<?=session()->get('category_id')?>">
